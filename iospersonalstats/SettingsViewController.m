...
- (id)init
{
    NSLog(@"SettingsViewController.init Entered");
    ...
    NSLog(@"SettingsViewController.init Exited");
...
-(void)actionCall
{
    NSLog(@"SettingsViewController.actionCall Entered");
    NSLog(@"SettingsViewController.actionCall Exited");
}

-(void)textDidChange
{
  NSLog(@"SettingsViewController.textDidChange Entered");
  NSLog(@"SettingsViewController.textDidChange Exited");
}

-(void)textDidClear
{
  NSLog(@"SettingsViewController.textDidClear Entered");
  NSLog(@"SettingsViewController.textDidClear Exited");
}

-(void)addPersonToDb
{
  NSLog(@"SettingsViewController.addPersonToDb Entered");
  NSLog(@"SettingsViewController.addPersonToDb Exited");
}

- (void)viewDidLoad
{
  NSLog(@"SettingsViewController.viewDidLoad Entered");
  [super viewDidLoad];
  NSLog(@"SettingsViewController.viewDidLoad Exited");
}

- (void)didReceiveMemoryWarning
{
  NSLog(@"SettingsViewController.didReceiveMemoryWarning Entered");
  [super didReceiveMemoryWarning];
  NSLog(@"SettingsViewController.didReceiveMemoryWarning Exited");
}
